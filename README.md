...
My variation of this model can be summarized as follows: A component depends on its arguments and context, and evaluates to a sequence of child components. The arguments to each child component is derived solely from the parent's arguments and context. Each child extend its parent's context with its own local variables. This could be expressed a bit more formally as:
